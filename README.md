...
<img src="reports/figures/website_example.png" alt="alt text" width="600" align="center"/>
...
<img src="reports/figures/pitch_example.png" alt="alt text" width="600" align="center"/>
...
| Tone Number | Pinyin Mark | Example Pinyin | Example Hanzi | English translation |
| :---: | :---: | :---: | :---: | :--- |
| **Tone 1** | $\bar{\text{a}}$ (High-level) | mā | 妈 | Mother |
| **Tone 2** | $\acute{\text{a}}$ (Rising) | má | 麻 | Numb |
| **Tone 3** | $\check{\text{a}}$ (Dipping) | mǎ | 马 | Horse |
| **Tone 4** | $\grave{\text{a}}$ (Falling) | mà | 骂 | To scold |
| **Tone 5** | a (None) | ma | 吗 | (Question particle) |


Often this is depicted in a figure like this one:

<img src="reports/figures/tone_graph.png" alt="alt text" width="700"/>
